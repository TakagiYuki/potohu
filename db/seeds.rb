...
Event.create!(
  [{name: '小樽潮まつり', article: '初日に祭りの開催を知らせる「潮ふれこみ」、2日目に「潮ねりこみ」、最終日にレガッタ大会の「潮市民レガッタ」、漁船や屋形船による小樽港内パレードの「潮わたり」が行われる。',
   ...
   {name: '隅田川花火大会', article: '隅田川花火大会（すみだがわはなびたいかい）は、東京都の隅田川沿い（台東区浅草（右岸）・墨田区向島（左岸）周辺）の河川敷において毎年7月最終土曜日に行われる花火大会である。毎年8月に開催される江戸川区花火大会とともに東京二大花火大会の一つに数えられる。',
    image:File.open("./app/assets/images/image002.jpg"),
    prefecture: '東京都', city:'台東区', street:'今戸1-1-10',
    date: "2020年8月24日", time_status: 0, area_id: 3},
   {name: 'はいさい', article: '隅田川花火大（すみだがわはなびたいかい）は、東京都の隅田川沿い（台東区浅草（右岸）・墨田区向島（左岸）周辺）の河川敷において毎年7月最終土曜日に行われる花火大会である。毎年8月に開催される江戸川区花火大会とともに東京二大花火大会の一つに数えられる。',
    image:File.open("./app/assets/images/image003.jpg"),
    prefecture: '東京都', city:'台東区', street:'今戸1-1-10',
