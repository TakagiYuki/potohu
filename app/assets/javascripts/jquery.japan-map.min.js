...
$(function(){
	    var areaLinks = {
		   1:"http://localhost:3000/events?area_id=1",
		   2:"http://localhost:3000/events?area_id=2",
		   3:"http://localhost:3000/events?area_id=3",
		   4:"http://localhost:3000/events?area_id=4",
		   5:"http://localhost:3000/events?area_id=5",
		   6:"http://localhost:3000/events?area_id=6",
		   7:"http://localhost:3000/events?area_id=7",
		   8:"http://localhost:3000/events?area_id=8",
		   9:"http://localhost:3000/events?area_id=9"
		};
		//地域を設定
		//{"code":[地域のコード], "name": [地域の名前], "color":[地域につける色], "hoverColor":[地域をマウスでホバーしたときの色], "prefectures":[地域に含まれる都道府県のコード]}
		var areas = [
			{"code": 1, "name":"北海道", "color":"#07b53a", "hoverColor":"#e0b1fb", "prefectures":[1]},
			{"code": 2, "name":"東北",   "color":"#07b53a", "hoverColor":"#d6d4fd", "prefectures":[2,3,4,5,6,7]},
			{"code": 3, "name":"関東",   "color":"#07b53a", "hoverColor":"#c1d8fd", "prefectures":[8,9,10,11,12,13,14]},
			{"code": 4, "name":"中部",   "color":"#07b53a", "hoverColor":"#93ecc5", "prefectures":[15,16,17,18,19,20,21,22,23]},
			{"code": 5, "name":"関西",   "color":"#07b53a", "hoverColor":"#f6e8ac", "prefectures":[24,25,26,27,28,29,30]},
			{"code": 6, "name":"中国",   "color":"#07b53a", "hoverColor":"#ffe5b0", "prefectures":[31,32,33,34,35]},
			{"code": 7, "name":"四国",   "color":"#07b53a", "hoverColor":"#ffd7c5", "prefectures":[36,37,38,39]},
			{"code": 8, "name":"九州・沖縄", "color":"#07b53a", "hoverColor":"#ffcece", "prefectures":[40,41,42,43,44,45,46,47]}
		];
